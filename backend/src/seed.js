...
const insert = db.prepare(`
  INSERT OR REPLACE INTO artists (id, stage_name, genre, location, rate, image_url, bio)
...
insertMany(artists);
console.log(`Seed complete. Artists: ${db.prepare("SELECT COUNT(*) AS c FROM artists").get().c}`);
