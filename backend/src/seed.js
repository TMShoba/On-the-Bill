...
// Artists data
  const artists = [
    ...
    { id: "20", stage_name: "Musa Keys", genre: "Amapiano", location: "Johannesburg", rate: 16000, image_url: "/artists/musa-keys.webp", bio: "Amapiano star with massive cross-border appeal. Producer and performer with club-ready hits." },
    {
      ...
      location: "Pretoria",
      rate: 25000,
      image_url: "/artists/areece.jpg",
      bio: "One of South Africa's most respected lyricists. Known for introspective bars, independent hustle, and a cult following across the country.",
    },
    {
      id: "22",
      stage_name: "Dlala Thukzin",
      genre: "Gqom",
      location: "Durban",
      rate: 20000,
...

  {
    ...
    location: "Durban",
    rate: 20000,
    image_url: "/artists/dbn-gogo.jpq",
    bio: "One of South Africa's most recognized Amapiano DJs with major local and international performances."
  },
  {
    id: "23",
    stage_name: "Oscar Mbo",
    genre: "House",
    location: "Johannesburg",
    rate: 18000,
    image_url: "/artists/oscar-mbo.jpq",
    bio: "Deep house DJ and producer known for soulful grooves and premium live sets."
  }
...
// Insert artists in a transaction
